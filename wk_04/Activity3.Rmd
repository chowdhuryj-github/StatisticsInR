...
Repeat the simulation from part (d) but over the next 100 years instead. Be sure to use the set.set() function as before and call it something like "sim3." Then use this to create a plot similar to that of part (e). Your plot should have an appropriate title and axes labels.
