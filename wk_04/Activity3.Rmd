...
p <- c(no_pets_probability, one_pet_probability, two_pet_probability, three_pet_proability, four_pet_probability)
...
plot(X, p, type='h', main="Probability Mass Function of Number of Pets", xlab="Number of Pets", ylab="Probability", lwd=15)
...
barplot(p, col="blue", main="Bar Graph of Pet Owners", xlab="Number of Pets", ylab="Probability", ylim=c(0, 0.5))
...
plot(X, sum, type="s", main="Step Graph of Number of Pets vs Probability", xlab="Number of Pets", ylab="Probability")
...
expected_value <- (PMFPets[1, 1] * PMFPets[2, 1]) + (PMFPets[1, 2] * PMFPets[2, 2]) + (PMFPets[1, 3] * PMFPets[2, 3]) + (PMFPets[1, 4] * PMFPets[2, 4]) +
(PMFPets[1, 5] * PMFPets[2, 5])
print(paste("Expected Value Manual: ", expected_value))

# finding the sum of squares
sum_of_squares <- (PMFPets[1, 1]^2 * PMFPets[2, 1]) + (PMFPets[1, 2]^2 * PMFPets[2, 2]) + (PMFPets[1, 3]^2 * PMFPets[2, 3]) + (PMFPets[1, 4]^2 * PMFPets[2, 4])
...
Create a plot (a line graph or bar graph, depending on your preference) based on the table in part (g). Your plot should have an appropriate title and axes 
labels.

```{r}

# saving the plot
png("C:/GitHub/StatisticsInR/wk_04/plots/LinePlot.png", width=800, height=600)

# the first row of the pmf table
outcomes <- as.numeric(names(pmf_table))

# making a line plot
plot(outcomes, pmf_table, type="l", 
main="Line Graph of Probability Mass Function of 100 Coin Tosses", xlab="Number of Heads", ylab="Probability")
...
main="Line Graph of Probability Mass Function of 1000 Coin Tosses", xlab="Number of Heads", ylab="Probability")
...
probability_using_dpois <- dpois(0, 7) + dpois(1, 7) + dpois(2, 7) + dpois(3, 7) + dpois(4, 7)
...
# saving the plot
png("C:/GitHub/StatisticsInR/wk_04/plots/10YearsOfEarthquakes.png", width=800, height=600)
...
# saving the plot
png("C:/GitHub/StatisticsInR/wk_04/plots/100YearsOfEarthquakes.png", width=800, height=600)
...
# saving the plot
png("C:/GitHub/StatisticsInR/wk_04/plots/1000YearsOfEarthquakes.png", width=800, height=600)
...
**Answer:**
As the number of years increases, the shape of the bar plots are of a normal distribution and is uni-modal, however, they become increasingly right